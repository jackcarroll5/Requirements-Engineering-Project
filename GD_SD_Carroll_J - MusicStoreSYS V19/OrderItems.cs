...
namespace MusicStoreSYS
{
    class OrderItems
    {
       ...
       /* public void setOrderID(int orderID)
        ...
        public static DataSet getSuppOrdItems(DataSet DS, int OrderID)
        {
            ...
            String strSQL = "SELECT * FROM OrderItems WHERE OrdId = " + OrderID;
        ...
        public static DataSet getAllOrderItemsCDIDOrder(DataSet DS)
        {
            OracleConnection conn = new OracleConnection(DataConnect.orac);
        ...
        public static DataSet getAllOrderItemsUnitCostOrder(DataSet DS)
        {
            OracleConnection conn = new OracleConnection(DataConnect.orac);
            ...
            String strSQL = "SELECT * FROM OrderItems ORDER BY Unit_Cost";
            OracleCommand cmd = new OracleCommand(strSQL, conn);
        ...
        public static DataSet getAllOrderItemsQty(DataSet DS)
        {
            OracleConnection conn = new OracleConnection(DataConnect.orac);
            ...
            String strSQL = "SELECT * FROM OrderItems ORDER BY Qty";
            OracleCommand cmd = new OracleCommand(strSQL, conn);
