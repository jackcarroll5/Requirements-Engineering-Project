       ...
       yrReleased = 0000;
        ...
        public void updCD()
        {
            ...
            String strSQL = "UPDATE CDs SET CD_ID = '" + this.CD_ID.ToString() + "', Album_Name = '" + this.album_Name +
               ...
               "', Cost_Price = " + this.cost_Price.ToString() + ", Qty = " + this.qty.ToString() + " WHERE CD_ID = '" + this.CD_ID + "'";
        ...
        public void disCD()
        {
            ...
            String strSQL = "UPDATE CDs SET Availability: " + this.availability + "WHERE CD_ID = '" + this.CD_ID + "'";
