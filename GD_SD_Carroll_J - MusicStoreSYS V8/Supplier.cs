     ...
     public Supplier()
        ...
        public void updSupp()
        {
            ...
            String strSQL = "UPDATE Suppliers SET Supp_Name = '" + this.supp_Name.ToUpper() + "', PhoneNo = '" + this.phone_No +
                "', Email = '" + this.email + "', Street = '" + this.street + "', TownVillage = '" + this.townVillage + "', County = '" + this.county + "' WHERE Supp_Id = " + this.supp_ID;
        ...
        public void deregSupp()
        {
            OracleConnection myConn = new OracleConnection(DataConnect.orac);
            myConn.Open();

            String strSQL = "UPDATE Suppliers SET Status: " + this.status +  " WHERE Supp_Id = " + this.supp_ID;
