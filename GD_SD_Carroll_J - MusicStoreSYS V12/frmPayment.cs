...
namespace MusicStoreSYS
{
    public partial class frmPayment : Form
    {
        ...
        private void btnAcceptSupp_Click(object sender, EventArgs e)
        {
            ...
            payment.setPayDate(String.Format("0{0:dd-MMM-yy}", mthPaymentDate.ToString()));
        ...
        public void loadOrderItems()
        {
            ...
            for (int i = 0; i < DS.Tables["ss"].Rows.Count; i++)
                cboOrderID.Items.Add(DS.Tables[0].Rows[i][0].ToString().PadLeft(4, '0') + " " + DS.Tables[0].Rows[i][1].ToString() + " " + DS.Tables[0].Rows[i][2].ToString());
