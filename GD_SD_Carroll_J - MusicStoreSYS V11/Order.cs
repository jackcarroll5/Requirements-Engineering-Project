...
namespace MusicStoreSYS
{
    class Order
    {
        ...
        public Order(int orderID, string ordDate, decimal ordValue, int supp_ID, string status)
        {
            setOrderID(orderID);
            setOrdDate(ordDate);
        ...
        public void placeOrder()
        {
            ...
            ",'" + this.ordDate + "','" + this.ordValue + "','" +
             this.suppID.ToString() + "','" + this.status + "')";
        ...
        public void getOrd(int orderNo)
        {
            OracleConnection myConn = new OracleConnection(DataConnect.orac);
            myConn.Open();

            //Define SQL query get Ordersfor the Supplier that is chosen
            String strSQL = "SELECT * FROM  Orders WHERE OrderID = " + orderNo;
            ...
            if (dr.Read())
            {
                ...
                setOrdDate(dr.GetString(1));
                setOrdValue(dr.GetInt32(2));
                setSuppID(dr.GetInt32(3));
        ...
        public static DataSet getAllOrders(DataSet DS)
        {
            ...
            String strSQL = "SELECT * FROM Orders ORDER BY PaymentID";
